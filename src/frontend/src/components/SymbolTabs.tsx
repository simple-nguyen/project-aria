...
const SymbolTabs = ({
  ...
  return (
    <div className="overflow-x-auto bg-primary p-4 rounded-lg shadow [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-track]:bg-sky-300 [&::-webkit-scrollbar-thumb]:bg-sky-500 [&::-webkit-scrollbar-thumb]:rounded-full">
      <div>
